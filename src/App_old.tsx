      ...
      default:
        return (
          <div style={{ 
            ...
            <p>Sistema de controle de gastos desenvolvido com:</p>
            <ul>
    ...
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif', minHeight: '100vh' }}>
      ...
      <header style={{ 
        ...
        <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
          <button
            ...
            style={{
              padding: '8px 16px',
              backgroundColor: currentView === 'home' ? '#3b82f6' : '#f3f4f6',
          ...
          <button
            ...
            style={{
              padding: '8px 16px',
              backgroundColor: currentView === 'demo' ? '#3b82f6' : '#f3f4f6',
          ...
          <button
            ...
            style={{
              padding: '8px 16px',
              backgroundColor: currentView === 'about' ? '#3b82f6' : '#f3f4f6',
              color: currentView === 'about' ? 'white' : '#374151',
              border: 'none',
              borderRadius: '6px',
              cursor: 'pointer',
              fontWeight: '500'
      ...
      <footer style={{ 
        ...
        <p style={{ fontSize: '14px', marginTop: '5px' }}>
          Configure suas credenciais do Supabase para dados reais
        </p>
      </footer>
    </div>
  )
